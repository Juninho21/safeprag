...
export default function AdminUsers({ companyId: propCompanyId }: { companyId?: string }) {
  ...
  // If superuser, can use prop or see all. If normal user, MUST use authCompanyId
  const companyId = isSuperUser ? (propCompanyId || undefined) : authCompanyId;

  console.log('AdminUsers Render Corrected:', { propCompanyId, authCompanyId, resolvedCompanyId: companyId });
